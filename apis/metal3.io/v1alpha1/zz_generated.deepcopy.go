...
func (in *BareMetalHostSpec) DeepCopyInto(out *BareMetalHostSpec) {
	*out = *in
	...
	if in.HostProvisionerProperties != nil {
		in, out := &in.HostProvisionerProperties, &out.HostProvisionerProperties
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostProvisionerPropertyStatus) DeepCopyInto(out *HostProvisionerPropertyStatus) {
	*out = *in
	if in.Applied != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostProvisionerPropertyStatus.
func (in *HostProvisionerPropertyStatus) DeepCopy() *HostProvisionerPropertyStatus {
	if in == nil {
		return nil
	}
	out := new(HostProvisionerPropertyStatus)
	in.DeepCopyInto(out)
	return out
}
